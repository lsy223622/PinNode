...
// PinNode evaluates and patches this exact Tailscale core snapshot alongside
// the Android fork. Remove this replacement only when rebasing the documented
// upstream changes onto a newer core version.
